...
-----------------------------------------------------------------------
	...
	--------CODING CREW--------
	--CODER 1
	makeLuaText('CODER1', 'this script was made byRamenDominoes', 1000, 132, -1000)
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'TheLuc', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'icon bf encore by FreshTH',1000,132,-1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'fanmade song by kawaiipro8', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'TheLuc', 1000, 132, -1000)
